  ...
  <div>
    ...
    <section class="min-h-[80vh] flex items-center justify-center bg-on-surface text-white px-6 relative overflow-hidden">
      ...
      <div class="absolute inset-0 z-0">
        <img src="/images/gyms/tungelsta-gym-new.webp" alt="Tungelsta" class="w-full h-full object-cover opacity-50" />
      ...
      <div class="container">
        <div class="max-w-5xl mx-auto">
          ...
          <div class="text-center mb-10 md:mb-12">
            <div class="mb-12">
              <StickySectionChip label="13-18 år" color="blue" />
            </div>
          ...
          <div class="text-center">
            <NuxtLink to="/ungdomstraning" class="btn btn-light btn-lg">
              Läs mer om ungdomsträning
            </NuxtLink>
          </div>
        </div>
      </div>
    ...
    <!-- News -->
    <NewsSection title="Senaste nytt" site="tungelsta" :limit="3" />
        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div class="text-center mb-10 md:mb-12">
            ...
            <p class="text-xl md:text-2xl text-on-surface-dim leading-relaxed">
              Tungelstavägen 200, 137 94 Tungelsta
            </p>
          </div>
      ...
      <div class="container">
        <div class="relative overflow-hidden rounded-3xl lg:rounded-[2.5rem] bg-brand">
          ...
          <div class="py-24 md:py-32 lg:py-40 px-6 md:px-12 text-center text-white relative z-10 max-w-4xl mx-auto">
            <h2 class="font-display font-bold text-4xl md:text-6xl mb-8 uppercase tracking-tight">Välkommen hem</h2>
